...
// Token do bot
$token = "7375518050:AAGfPA64Yf0R1p8IO3RNoJzbeK0Lmyd-gIY";

// URL base da API do Telegram
$api_url = "https://api.telegram.org/bot$token/";

// Lista de administradores do bot
$administradores = ["PartizanMat", "junior", "lksdrago", "nitti"];  // Admss
...
function processarConsulta($chat_id, $comando, $parametro, $username) {
    ...
    $base_url = "https://777apis.vercel.app/api/nome_completo/?query=VALOR&apikey=sua_api_key";
    $key = "Sp3ctre667"; 
    $resultado = "";
...
function start($chat_id, $nome) {
    $txt = "🔹 *Bem-vindo, {$nome}*\n\n"
         . "• [Contato do Desenvolvedor](@PartizanMat)\n\n"
...
function consultasDisponiveis($chat_id, $message_id) {
  ...
  function realizarConsultaDireta($url) {
    echo "[INFO] URL gerada para a consulta: {$url}\n";
